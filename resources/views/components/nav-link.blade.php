...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-sky-700 text-sm font-semibold leading-5 text-slate-900 focus:outline-none focus:border-sky-800 transition duration-150 ease-in-out'
