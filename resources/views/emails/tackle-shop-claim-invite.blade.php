<x-mail::message>
# You're invited to claim {{ $tackleShop->name }}
...
I've added a listing for **{{ $tackleShop->name }}** and would love for someone from the shop to claim and manage it — keeping details up to date and connecting with local anglers.

<x-mail::button :url="route('tackle-shops.show', $tackleShop)">
View your tackle shop page
</x-mail::button>

**How to claim ownership**

1. [Register]({{ route('register') }}) for a free account (or [log in]({{ route('login') }}) if you already have one)
2. Open your [tackle shop page]({{ route('tackle-shops.show', $tackleShop) }})
3. Click **Claim ownership** and submit a short request

I'll review claims promptly and hand over management once verified.

If this isn't the right contact, feel free to forward it to whoever runs the shop — or reply and point me in the right direction.
