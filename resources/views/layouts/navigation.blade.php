<nav x-data="{ open: false }" class="bg-white border-b border-slate-200 dark:bg-slate-900 dark:border-slate-700">
        ...
        <div class="flex justify-between h-16 gap-4">
            <div class="flex items-center gap-6 min-w-0">
                <a href="{{ route('home') }}" class="flex items-center gap-2.5 shrink-0">
                    ...
                    <span class="font-bold text-slate-900 tracking-tight hidden md:inline text-[15px] whitespace-nowrap dark:text-slate-100">NE Coarse Fishing</span>
                </a>
            ...
            <div class="hidden lg:flex lg:items-center lg:gap-3 shrink-0">
                @auth
                    ...
                    <a href="{{ route('sessions.create') }}" class="inline-flex items-center px-3.5 py-2 text-sm font-semibold rounded-lg border border-slate-300 text-slate-800 hover:bg-slate-50 whitespace-nowrap dark:border-slate-600 dark:text-slate-100 dark:hover:bg-slate-800">
                        Log Session
                    </a>
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center max-w-[11rem] px-3 py-2 text-sm font-medium rounded-md text-slate-700 hover:text-slate-900 dark:text-slate-200 dark:hover:text-white">
                ...
                @else
                    <a href="{{ route('login') }}" class="inline-flex items-center px-3.5 py-2 text-sm font-semibold rounded-lg border border-sky-800 text-sky-900 hover:bg-sky-50 dark:border-sky-400 dark:text-sky-200 dark:hover:bg-slate-800">Log in</a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden border-t border-slate-200 dark:border-slate-700 dark:bg-slate-900">
